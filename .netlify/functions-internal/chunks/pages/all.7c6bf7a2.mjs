...
const $$Astro$8 = createAstro("https://selfhostlab.com");
...
const $$Astro$7 = createAstro("https://selfhostlab.com");
  ...
  <nav class="w-full top-0 bg-white z-10 dark:bg-slate-900">
    <div class="container mx-auto py-5 flex items-center justify-between">
      <div class="flex item-center gap-2">
        <img class="item-center w-40 h-28" src="/logo.png" alt="logo">
      ...
      <img src="/moon.png" class="hidden md:block w-5 h-5 cursor-pointer" alt="moon">
...
const $$Astro$6 = createAstro("https://selfhostlab.com");
...
const $$Astro$5 = createAstro("https://selfhostlab.com");
const $$HeroHome = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <section class="mb-16">
    <div class="relative overflow-hidden bg-no-repeat bg-cover" style="
          ...
          background-image: url('/toronto-window-cleaning-bg.webp');
          height: 500px;
        ">
...
const $$Astro$4 = createAstro("https://selfhostlab.com");
    ...
    <div class="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
      <div class="p-3 mb-12 md:mb-0">
        <div class="flex justify-center mb-6">
          <img src="/anna.webp" class="rounded-full shadow-lg w-32 h-32" alt="women head image">
        </div>
      ...
      <div class="p-3 rounded-lg mb-12 md:mb-0">
        <div class="flex justify-center mb-6">
          <img src="/angelina.webp" alt="women-2 head image" class="rounded-full shadow-lg w-32 h-32">
        </div>
      ...
      <div class="mb-0">
        <div class="p-3 rounded-lg mb-12 md:mb-0">
          <div class="flex justify-center mb-6">
            <img src="/doug.webp" class="rounded-full shadow-lg w-32 h-32" alt="man head image">
          </div>
...
const $$Astro$3 = createAstro("https://selfhostlab.com");
...
const $$Astro$2 = createAstro("https://selfhostlab.com");
      ...
      <div class="px-6 py-12 md:px-12">
        <div class="grid lg:grid-cols-2 lg:gap-x-12 items-center">
          ...
          <div class="mr-14 mb-12 lg:mb-0">
            <img src="/gutter-cleaning-5.webp" class="w-full h-full rounded-lg sshadow-lg" alt="gutter cleaning image">
          </div>
        </div>
      </div>
    </section>
...
const $$Astro$1 = createAstro("https://selfhostlab.com");
const $$IntroSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="container mx-auto xl:px-32 text-center lg:text-left">
    <div class="grid lg:grid-cols-2 items-center">
      ...
      <div>
        <img src="/toronto-window-cleaning_1.webp" class="w-full h-full rounded-lg shadow-lg" alt="before and after image">
      </div>
    </div>
  </div>
</section>`;
...
const $$Astro = createAstro("https://selfhostlab.com");
